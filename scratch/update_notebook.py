...
if step4_start != -1:
    ...
    option_b_cell = {
        ...
        "source": [
            ...
            "# --max_shard_size '500MB' splits weights into sharded files and creates model.safetensors.index.json\n",
            "# --save_epochs saves checkpoint folders indexed by epoch (e.g., checkpoint-epoch-1)\n",
            "!python train_kite.py \\\n",
            "    --model_path \"./kite1.0\" \\\n",
            "    --mode \"full\" \\\n",
