...
class KiteProcessor(ProcessorMixin):
    r"""
    Constructs a Kite processor which wraps a Kite vision processor and a tokenizer into a single processor.

    [`KiteProcessor`] offers all the functionalities of [`KiteVisionProcessor`] and [`TikTokenTokenizer`]. See the
    [`~KiteProcessor.__call__`] and [`~KiteProcessor.decode`] for more information.

    Args:
        image_processor ([`KiteVisionProcessor`], *optional*):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.video_placeholder = "<|kite_video_placeholder|>"
    ...
    def __call__(self,
                 ...
                 **kwargs) -> BatchFeature:
        """
        Process multimodal inputs for Kite model.
