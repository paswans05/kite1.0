...
class KiteVisionConfig(PretrainedConfig):
    ...
    def __init__(
            ...
            video_placeholder="<|kite_video_placeholder|>",
...
class KiteConfig(PretrainedConfig):
    """Kite model configuration.
    ...
    def __init__(
        ...
        vision_config: dict | KiteVisionConfig = None,
        # Other parameters
        ignore_index: int = -100,
        media_placeholder_token_id: int = 163605,
        pad_token_id: int = 0,
        ...
        **kwargs,
        ...
        if isinstance(vision_config, dict):
            vision_config = KiteVisionConfig(**vision_config)
